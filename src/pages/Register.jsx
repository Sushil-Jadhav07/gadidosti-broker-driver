...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      {/* ── Left Panel (desktop only) — same solid green gradient as Login.jsx and the
          client portal, so all three GadiDost apps match. ── */}
      <div
      ...
      >
        ...
        <div className="relative z-10">
          <h1 className="text-4xl font-bold text-white font-poppins leading-tight mb-4">
            Join India&apos;s Leading<br />Logistics Network
          </h1>
          <p className="text-white/70 font-inter text-[15px] mb-10 leading-relaxed">
            Register as a broker managing a fleet, or a driver ready to hit<br />the road — set up your account in minutes.
          </p>
        ...
        <p className="relative z-10 text-[11px] text-white/30 font-inter">© 2024 SSK Logistics. All rights reserved.</p>
      </div>
