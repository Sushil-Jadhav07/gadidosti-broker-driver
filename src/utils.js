...
// can. headingDeg comes from the GPS device's course/bearing field (a string per the vendor's
// API, e.g. "75" — Number.isFinite doesn't coerce strings, coerced with Number() first or it'd
// always fall back to 0). Defaults to 0 (pointing up/north) when unknown rather than skipping
// rotation entirely.
//
