...
// backend emits 'trip-status-updated' straight to the driver's and broker's own socket rooms
// alike (see gadidosti-backend's trip.controller.js emitTripStatusUpdate) on every
// PATCH /api/trips/:id/status call, whoever made it. Same connect/auth/cleanup shape as
