...
import TruckLocation  from "./pages/broker/TruckLocation";
      ...
      <AuthProvider>
        <ToastProvider>
          ...
          <Routes>
            ...
            <Route path="/trucks/:id/location" element={<PrivateRoute role="broker"><BrokerAppLayout><TruckLocation /></BrokerAppLayout></PrivateRoute>} />
            ...
            <Route path="/monthly-hiring/new" element={<PrivateRoute role="broker"><BrokerAppLayout><MonthlyHiringForm /></BrokerAppLayout></PrivateRoute>} />
            ...
            <Route element={<PrivateRoute role="driver"><DriverAppLayout /></PrivateRoute>}>
              ...
              <Route path="/driver/monthly-hiring/new" element={<MonthlyHiringForm />} />
            </Route>
