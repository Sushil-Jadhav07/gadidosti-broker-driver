...
//
// headingDeg comes from the driver's live location ping (a string in some payloads — coerced
// with Number() first since Number.isFinite doesn't coerce strings, or it'd always fall back
// to 0). Defaults to 0 (pointing up/north) when unknown.
